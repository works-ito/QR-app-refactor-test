...
(function() {
  ...
  loadScript("https://cdn.jsdelivr.net/npm/zxing-wasm@3.1.3/dist/iife/reader/index.js")
    ...
    .then(function() { return loadScript("./irregular-master-send-bridge-dev.js?v=87"); })
    ...
    .then(function() { return loadScript("./irregular-return-photo-diagnostic-dev.js?v=2"); })
